...
class AttendClassAction extends RightAction {
	...
	public function basicExport(){
		...
		$objPHPExcel->setActiveSheetIndex()->setCellValue('C2',"学部代号");
		$objPHPExcel->setActiveSheetIndex()->setCellValue('D2',"学部名称");
	...
	public function noQualifyExport(){
		...
		if(intval($type)==0){
			...
			$objPHPExcel->setActiveSheetIndex()->setCellValue('J2',"学部代号");
			$objPHPExcel->setActiveSheetIndex()->setCellValue('K2',"学部名称");
