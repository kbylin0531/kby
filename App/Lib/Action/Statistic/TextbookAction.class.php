...
class TextbookAction extends RightAction {
	...
	public function teacherExp(){
		...
		$objPHPExcel->setActiveSheetIndex()->setCellValue('E2',"所在学部");
		//设置个别列内容居中
	...
	public function classExp(){
		...
		$objPHPExcel->setActiveSheetIndex()->setCellValue('F2',"所属学部");
		//设置个别列内容居中
	...
	public function courseExp(){
		...
		$objPHPExcel->setActiveSheetIndex()->setCellValue('D2',"开课学部");
	...
	public function coursePlanExp(){
		...
		$objPHPExcel->setActiveSheetIndex()->setCellValue('J2',"学部名称");
