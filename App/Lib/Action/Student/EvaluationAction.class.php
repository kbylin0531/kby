...
class EvaluationAction extends RightAction {
    ...
    public function qlist(){
        ...
        $list=$tab->join('教学质量评估详细 on 教学质量评估综合.recno=教学质量评估详细.map')
            ...
            ->field('
teachers.name,row_number() over(order by rank) as row,teachers.name as TEACHERNAME,教学质量评估详细.MAP,
...
教学质量评估详细.TOTAL as FRACTION,教学质量评估综合.YEAR  YEAR,教学质量评估综合.TERM AS TERM')
